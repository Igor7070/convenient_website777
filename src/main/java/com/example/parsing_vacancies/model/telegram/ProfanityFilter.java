...
public class ProfanityFilter {
    ...
    private static final List<String> badWords = Arrays.asList("хуй", "блять", "блядь", "пизд",
            ...
            "хуе", "ебал", "вхуй", "вхуя", "выеб", "выхуя", "вьеб", "говноеб", "голоебица", "хер",
            ...
            "суки", "новохудоносок", "хуї", "їбат", "їбна", "єбан", "єблан", "єбаш", "їбаш", "заїб",
    ...
    private static final List<String> apologies = Arrays.asList("извини", "извиняюс", "пощади",
            "прости", "каюсь", "я не прав", "прошу прощения", "вибач", "сорян", "сори",
            "прошу вибачення");
    ...
    public static String reactionToSwearing(UserData userData) {
        ...
        switch (countBadMessage) {
            case 1:
                ...
                break;
            case 2:
                responce = "Блять, я ж сказал один раз, ты совсем путаешь с кем разговариешь? Не " +
            ...
            case 3:
                responce = "Так что тебя отпиздить? Даю еще шанс один. Или извиняйся немедленно или " +
                        "потом пеняй на себя...";
                break;
            case 4: responce = "Ну все придется дать пизды, не понял человек, хотел по хорошему! " +
