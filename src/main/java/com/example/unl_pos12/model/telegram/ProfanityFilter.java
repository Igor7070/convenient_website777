package com.example.unl_pos12.model.telegram;
...
public class ProfanityFilter {
    ...
    private static final List<String> badWords = Arrays.asList("хуй", "блять", "блядь", "пизд",
            ...
            "довбоеб", "пізд", "блят", "їбан", "єб тво", "єбтв", "ебу", "єбу", "їбуч", "єбуч", "забздіт", "забздід",
            "забздів", "пздів", "єбла", "їбла", "єдрєн", "єдрен", "їбен", "їбєн", "шароєб", "дуроєб",
            "уєб", "їба", "їбу", "ибану", "їблан", "сучий", "хєр", "хує", "їдрен", "їдрєн", "єдрєн", "єдрен",
    ...
    private static final List<String> apologies = Arrays.asList("извини", "извиняюс", "пощади",
            ...
            "sorri", "sory", "sori", "soryan", "прошу вибачення", "звиняй");
